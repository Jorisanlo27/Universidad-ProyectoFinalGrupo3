...
//                optionsBuilder.UseSqlServer("klk");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Asignatura>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo, "UQ__Asignatu__40F9A206C49951BA")
                    .IsUnique();
            ...
            modelBuilder.Entity<Clase>(entity =>
            {
                ...
                entity.HasOne(d => d.IdAsignaturaNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Clase_Asignaturas");

                entity.HasOne(d => d.IdCursoNavigation)
                    .WithMany(p => p.Clases)
                    .HasForeignKey(d => d.IdCurso)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Clase_Cursos");

                entity.HasOne(d => d.IdProfesorNavigation)
                    .WithMany(p => p.Clases)
                    .HasForeignKey(d => d.IdProfesor)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Clase_Profesores");
            });
            ...
            {
                entity.ToTable("Estudiantes_Clase");
                ...
                entity.HasOne(d => d.IdClaseNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Clase_Estudiantes_Clase");
            ...
            modelBuilder.Entity<Persona>(entity =>
            {
                ...
                entity.HasIndex(e => e.Matricula, "UQ__Personas__30962D152C155CD7")
                    .IsUnique();

                entity.HasIndex(e => e.Cedula, "UQ__Personas__415B7BE5E17B1C9B")
                    .IsUnique();
